...
O3plot2 <- ggplot(EPAair) +
  #geom_point(aes(x = Date, y = Ozone, color = "blue")) This can not give a figure with all blue dots cuz it is just adding another layer with a "blue" variable
