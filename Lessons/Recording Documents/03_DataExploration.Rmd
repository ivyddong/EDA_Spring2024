...
str(USGS.flow.data) #show the dataframe and all the content you have
dim(USGS.flow.data) #dimension, how many rows and columns in the dataset
length(USGS.flow.data) #how many columns in the dataset

head(USGS.flow.data) #Automatically show the first 6 rows of the dataset without specific mentioning
head(USGS.flow.data, 10) #Specifically the first 10 rows
tail(USGS.flow.data, 5) #the bottom of the dataset
USGS.flow.data[30000:30005, c(3, 8, 14)] #[row30000:row30005,column(3,8,14)]
